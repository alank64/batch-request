...
var batchRequest = function(params) {
    ...
    params.forceRequestDefaults = (typeof params.forceRequestDefaults === 'undefined') ? false : params.forceRequestDefaults;
    params.requestDefaults = (typeof params.requestDefaults === 'undefined') ? {} : params.requestDefaults;
    ...
    var batch = function(req, res, next) {
        ...
        var requestPromises = _.reduce(requests, function(promises, r, key) {
            if (!r.dependency || r.dependency === 'none') {
              ...
              _.each(params.requestDefaults, function(requestDefault_v, requestDefault_k) {
                if (params.forceRequestDefaults){
                  r[requestDefault_k] = requestDefault_v;
                } else if (!(requestDefault_k in r)){
                  r[requestDefault_k] = requestDefault_v;
                }
              });
